...
The current benchmark contains 130 cases across 53 repositories and 127 manually reviewed symbol
targets across 95 cases. This is materially stronger for error analysis but still not statistically
...
120-case batch, and version 16 is the current 130-case reviewed batch toward the planned 200-case
suite.
LLM hypotheses are
