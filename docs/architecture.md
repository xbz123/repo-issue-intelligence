...
The current benchmark contains 100 cases across 46 repositories and 97 manually reviewed symbol
targets across 72 cases. This is materially stronger for error analysis but still not statistically
...
11 is the retained 80-case batch, version 12 is the retained 90-case batch, and version 13 is the
current 100-case reviewed batch toward the planned 200-case suite.
LLM hypotheses are
