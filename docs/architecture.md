...
The current benchmark contains 120 cases across 52 repositories and 121 manually reviewed symbol
targets across 89 cases. This is materially stronger for error analysis but still not statistically
...
retained 100-case batch, version 14 is the retained 110-case batch, and version 15 is the current
120-case reviewed batch toward the planned 200-case suite.
LLM hypotheses are
