...
The current benchmark contains 140 cases across 56 repositories and 135 manually reviewed symbol
targets across 101 cases. This is materially stronger for error analysis but still not statistically
...
120-case batch, version 16 is the retained 130-case batch, and version 17 is the current 140-case
reviewed batch toward the planned 200-case suite.
LLM hypotheses are
