...
Three complete deterministic v0.23 evaluations produced identical candidates, symbols, and metrics
...
reach Symbol Recall@1 `0.3182`, Recall@5 `0.5152`, Recall@10 `0.5455`, Recall@20 `0.6515`, and
MRR `0.4555`. v0.17's scope-safe function-local import edges recovered Rich's `highlighter.py` at
